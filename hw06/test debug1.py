...
def test_suite():
    """
    All expected caesar values are forward shifts. If a negative value is
    received by the caesar() function, simply add 26 to it and it should
    properly compare with the expected caesar output.
    :return: None
    """
